...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gradient-to-br ">
      {/* Header */}
      <header className="bg-white border-b border-stroke dark:bg-black/20 dark:border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{artistName}</h1>
                <p className="text-slate-600 dark:text-gray-300 text-sm">Artist Dashboard</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="bg-gray-100 text-slate-800 border border-stroke pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 dark:bg-white/10 dark:text-white dark:border-white/20"
                />
              </div>
              <button className="bg-gray-100 text-slate-800 p-2 rounded-lg border border-stroke hover:bg-gray-200 transition-colors dark:bg-white/10 dark:text-white dark:border-white/20 dark:hover:bg-white/20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Period Selector */}
        <div className="mb-8">
          <div className="flex space-x-2 bg-gray-100 p-1 rounded-lg border border-stroke w-fit dark:bg-white/10 dark:border-white/20">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                  selectedPeriod === period
                    ...
                    : 'text-slate-700 hover:text-slate-900 hover:bg-gray-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-white/10'
                }`}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gradient-to-br dark:from-purple/20 dark:to-slate-500/20 rounded-2xl p-6 border border-stroke dark:border-white/10">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-slate-600 dark:text-gray-300">Total Airplay</div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gradient-to-br dark:from-green/20 dark:to-emerald/20 rounded-2xl p-6 border border-stroke dark:border-white/10">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-slate-600 dark:text-gray-300">Total Earnings</div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gradient-to-br dark:from-blue-500/20 dark:to-cyan-600/20 rounded-2xl p-6 border border-stroke dark:border-white/10">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-slate-600 dark:text-gray-300">Streaming Plays</div>
              </div>
            </div>
            <div className="text-xs text-blue-400">↑ 45.7% from last month</div>
          </div>

          <div className="bg-white dark:bg-gradient-to-br dark:from-orange-500/20 dark:to-red-600/20 rounded-2xl p-6 border border-stroke dark:border-white/10">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-slate-600 dark:text-gray-300">Active Stations</div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Plays Over Time */}
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
                ...
                {playsOverTime.map((month, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600 dark:text-gray">{month.date}</span>
                      <div className="flex space-x-4">
                        <span className="text-slate-600 dark:text-gray">
                    ...
                    <div className="flex space-x-2">
                      <div className="flex-1 bg-gray-200 dark:bg-white/10 rounded-full h-3 overflow-hidden">
                        <div
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-sm text-slate-600 hover:text-slate-900 dark:text-gray-300 dark:hover:text-white flex items-center">
              ...
              <div className="space-y-4">
                {topSongs.map((song, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-stroke hover:bg-gray-100 transition-colors dark:bg-white/5 dark:border-white/10 dark:hover:bg-white/10"
                  >
                    <div className="flex items-center space-x-4">
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              <div className="flex items-center justify-between mb-6">
                ...
                <select
                  className="bg-gray-100 text-slate-800 px-3 py-2 rounded-lg border border-stroke focus:outline-none focus:ring-2 focus:ring-green-400 dark:bg-white/10 dark:text-white dark:border-white/20"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {ghanaRegions.map((region, index) => (
                  <div
                    key={index}
                    className="p-4 bg-gray-50 rounded-xl border border-stroke hover:bg-gray-100 transition-colors dark:bg-white/5 dark:border-white/10 dark:hover:bg-white/10"
                  >
                    ...
                    <div className="mt-3 w-full bg-gray-200 dark:bg-white/10 rounded-full h-2">
                      <div
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              ...
              <div className="space-y-4">
                {stationBreakdown.map((station, index) => (
                  <div
                    key={index}
                    className="p-3 bg-gray-50 rounded-xl border border-stroke dark:bg-white/5 dark:border-white/10"
                  >
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              ...
              <div className="space-y-4">
                {fanDemographics.map((demo, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600 dark:text-gray-300">{demo.ageGroup}</span>
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              ...
              <div className="text-center space-y-4">
                ...
                <div className="text-sm text-slate-600 dark:text-gray-300">Out of 10</div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-300">Airplay Growth</span>
                    <span className="text-green-600 dark:text-green-400">
                      {performanceScore.airplayGrowth}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-300">Regional Reach</span>
                    <span className="text-blue-400">
                      {performanceScore.RegionalReach}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-300">Fan Engagement</span>
            ...
            <div className="bg-white rounded-2xl p-6 border border-stroke dark:bg-white/10 dark:border-white/20">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full bg-gray-100 text-slate-900 py-3 rounded-xl font-semibold border border-stroke hover:bg-gray-200 transition-colors flex items-center justify-center dark:bg-white/10 dark:text-white dark:border-white/20 dark:hover:bg-white/20">
