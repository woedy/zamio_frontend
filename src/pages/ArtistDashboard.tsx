...
export default function MusicRoyaltiesDashboard() {
    ...
    <div className="flex flex-col lg:flex-row w-full p-2 gap-4">
      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-9 gap-4 mb-6">
          {/* Total Airplays */}
          <div className="col-span-1 md:col-span-2 flex flex-col items-center bg-indigo-900/20 rounded-lg p-4">
          ...
          {/* Chart */}
          <div className="col-span-1 md:col-span-5 bg-indigo-900/30 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center bg-indigo-900/20 rounded-lg p-4">
        ...
        <div>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
            ...
            <button className="px-3 py-1 sm:px-4 sm:py-2 bg-indigo-600 rounded-lg hover:bg-indigo-700 transition text-sm sm:text-base">
              View All
            </button>
          </div>
          <div className="bg-indigo-900/30 rounded-lg overflow-x-auto">
